...
/// SQLite itself is not bundled - same policy as CSGtk.Gtk.Native.* for GTK: it must already be
...
/// redistributable per-platform NuGet package like CSGtk.Gtk.Native.*.
/// </summary>
internal static class SqliteNativeResolver
{
    ...
    // --- Windows: same MSYS2/gvsbuild directories CSGtk.Gtk.Native.Windows already scans for GTK ---
